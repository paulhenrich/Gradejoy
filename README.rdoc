...
You will need to place a secret key in config/initializers/secret_token.rb on line 12 in
...
config/initializers/devise.rb in the place of ENV["DEVISE_SECRET_KEY"]. You can also
use the Figaro gem (https://github.com/laserlemon/figaro) if you would like to handle environment variables.
